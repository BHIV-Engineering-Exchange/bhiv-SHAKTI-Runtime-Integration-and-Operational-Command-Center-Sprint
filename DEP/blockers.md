...
| **Missing Production Telemetry Logs** | VM Operator (Alay) | **Medium** | Previously required container and API telemetry verification. | **Resolved** (2026-08-13 / 2026-09-04). VM container status, runtime serving logs, and all 11 backend service telemetry payloads are captured in `evidence_packet/runtime_logs/`. |
